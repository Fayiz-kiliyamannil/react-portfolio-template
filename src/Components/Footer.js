...
<footer className=" bg-gradient-to-b from-gray-100 to-blue-100   ">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 className="mb-6 text-sm font-bold text-gray-950 uppercase ">Projects</h2>
              ...
              <div>
                  <h2 className="mb-6 text-sm font-bold text-gray-950 uppercase">Legal</h2>
                  <ul className="text-gray-500 dark:text-gray-900 font-medium">
                      <li className="mb-4">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-800">© 2024 <Link to="#" className="hover:underline">Kiliyamannil groups™</Link>. All Rights Reserved.
          </span>
          <div className="flex mt-4 sm:justify-center sm:mt-0">
              ...
              <Link to="#" className="text-gray-800 hover:text-gray-900  ms-5">
