...
function navbar() {
    ...
    return (
        <>
            ...
            <div className='bg-gray-200 sm:hidden  w-[100%] h-[50px] bottom-0 fixed flex items-center  ' >
                <div className='flex list-none  justify-center w-[100%] justify-between px-24   ' >
                    <NavLink>
                        <svg className="w-6 h-6 text-gray-900  mt-2 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    ...
                    <NavLink>
                        <svg className="w-6 h-6 text-gray-900 mt-2  " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
